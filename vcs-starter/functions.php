...
// javascript.js
        ...
        wp_register_script('jquery', ASSETS_URL .'/assets/js/jquery-3.3.1.min.js', array(), false, true);
         wp_register_script('javascript', ASSETS_URL .'/assets/js/javascript.js', array('jquery'), false, true);
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		...
		wp_register_style('stilius', ASSETS_URL .'/assets/css/style.css',array(),false,'all');

		wp_register_style('icomoon', ASSETS_URL .'/assets/css/icomoon.css',array('stilius'),false,'all');
